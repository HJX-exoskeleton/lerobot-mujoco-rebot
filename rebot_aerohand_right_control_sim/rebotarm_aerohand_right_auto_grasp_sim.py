...
运动与触觉可视化
python rebotarm_aerohand_right_auto_grasp_sim.py --save-plots ./auto_grasp_results --save-videos ./auto_grasp_results

无界面采集：
python rebotarm_aerohand_right_auto_grasp_sim.py --headless --seed 1

关闭仿真画面快速录制视频：
python rebotarm_aerohand_right_auto_grasp_sim.py --save-videos ./auto_grasp_results --no-viewer
python rebotarm_aerohand_right_auto_grasp_sim.py --save-videos ./auto_grasp_results --no-viewer --render-gpu nvidia
