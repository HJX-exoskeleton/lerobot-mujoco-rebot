...
# 滤波关掉的指令
# python servo_arm_teleoperation_sim.py --xml /media/hjx/新加卷/hjx_ws/lerobot-mujoco-rebot/asset_rebot/rebotarm_sim_transfer_cube.xml --port /dev/ttyUSB0 --baudrate 115200 --read-rate 60 --rate 400 --viewer-hz 60 --alpha-arm 1.0 --alpha-gripper 1.0
