...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.description = "reBot 主从遥操作 -> ACT LeRobot多模态数据集（异步写入）"
    parser.set_defaults(
        xml=DEFAULT_XML,
        cfg=DEFAULT_ARM_CFG,
    ...
    parser.add_argument(
        "--root",
        type=Path,
        default=PROJECT_ROOT / "data_act_real" / "rebot_act_banana",
    ...
    parser.add_argument(
        ...
        "--instruction",
        dest="task",
        default="rebot_real_banana",
        help="写入LeRobot task字段的任务名称；--instruction为兼容别名",
    )
