#!/usr/bin/env python3
"""Inspect a real reBot LeRobot dataset without connecting to hardware.
...
Inspect another dataset and save a machine-readable report::
    ...
    python -m rebot_smolvla_real.workflow.inspect_dataset \
      ...
      --json-report ./data_vla_real/dataset_report.json
...
DEFAULT_ROOT = PROJECT_ROOT / "data_vla_real" / "rebot_smolvla_multimodal"
...
def print_report(report: dict[str, Any]) -> None:
    ...
    print("\n" + "=" * 96)
    print("reBot SmolVLA / LeRobot 数据集检查报告")
    print("=" * 96)
...
def build_argparser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="检查并介绍reBot LeRobot数据集")
