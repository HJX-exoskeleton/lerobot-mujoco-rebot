#!/usr/bin/env python3
"""重播 LeRobot 真机 VLA episode，并同步显示全部传感器。
...
class SensorVisualizer:
    WINDOW = "reBot LeRobot Episode Replay"
...
def build_argparser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="reBot LeRobot 多传感器轨迹重播")
