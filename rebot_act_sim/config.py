...
DEFAULT_CONFIG = PACKAGE_ROOT / "configs" / "act_sim.yaml"
...
def tactile_processing_kwargs(raw: dict) -> dict:
    value = raw["environment"].get("tactile_processing")
    return {} if value is None else {"tactile_processing": dict(value)}
